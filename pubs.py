...
CONFERENCES = {
    ...
    #'sys_embed': ['EMSOFT', 'RTAS', 'RTSS', 'rtss', 'IEEE Real-Time and Embedded Technology and Applications Symposium', 'ACM Trans. Embedded Comput. Syst.', 'ACM Trans. Embed. Comput. Syst.'],
    'sys_embed': ['EMSOFT', 'RTAS', 'RTSS', 'rtss', 'ACM Trans. Embedded Comput. Syst.', 'ACM Trans. Embed. Comput. Syst.'],
    #'sys_embed': ['EMSOFT', 'EMSOFT Companion', 'RTAS', 'RTSS', 'rtss'],
    'sys_hpc': ['HPDC', 'ICS', 'SC'],
